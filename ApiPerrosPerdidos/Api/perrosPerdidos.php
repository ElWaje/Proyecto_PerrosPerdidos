...
try {
    ...
    $query = "SELECT p.nombre, p.raza, p.edad, p.collar, p.chip, p.lugarPerdido, p.fechaPerdido, p.lugar, p.fechaUltimaActualizacion, p.foto, p.color, p.tamano, p.descripcion, u.nombre AS nombreDueno 
              FROM perros p
