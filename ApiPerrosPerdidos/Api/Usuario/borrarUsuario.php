...
<head>
    ...
    <style>
        ...
        @media screen and (max-width: 480px) {
            ...
            .selector-select, .selector-submit {
                font-size: 14px;
            }
...
<body>
    ...
    <div class="contenido"> 
        ...
        <h2 class="titulo-2">Selección de usuario a borrar</h2>
            ...
            <form action="eliminarUsuario.php" method="POST">
                ...
                <select name="usuarioId" id="usuario" class="selector-select">
                    ...
                    <?php foreach ($usuarios as $usuario): ?>
                        <option value="<?php echo $usuario['id'] . ',' . $usuario['nombre']; ?>"><?php echo $usuario['nombre']; ?></option>
                    <?php endforeach; ?>
                </select>
                <input type="submit" value="Borrar Usuario" class="selector-submit">
            </form>
        </div>
    </div>  
