...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        procesarCambioAutor($conn, $_POST, $selectedComentarioId);
    }
...
function procesarCambioAutor($conn, $postData, $comentarioId) {
    $selectedUserId = $postData['idUsuario'] ?? null;

    if (!$selectedUserId) {
        redirectToIndexWithError("No se ha seleccionado un autor.");
    }

    $sqlActualizarIdUsuario = "UPDATE Comentarios SET idUsuario = :idUsuario, idAutor = :idAutor WHERE id = :idComentario";
    ...
    $stmtActualizarIdUsuario->bindParam(':idComentario', $comentarioId);
...
<head>
    ...
    <title>Editar Comentario Formulario</title>
...
<body>
    ...
    <div class="contenido">
            ...
            <div class="editar-comentario-container">
                ...
                <form action="editarComentarioFormulario.php?comentario=<?php echo htmlspecialchars($selectedComentarioId); ?>" method="POST">
