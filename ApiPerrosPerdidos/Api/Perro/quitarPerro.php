...
function mostrarPerros($perros,$idUsuario) {
    foreach ($perros as $perro) {
        echo '<option value="' . $perro['id'] . ',' . $perro['nombre'] . ',' . $idUsuario . '">' . $perro['id'] . ' - ' . $perro['nombre'] . '</option>';
    }
}
?>
...
<div class="contenido">
    ...
    <h2 class="titulo-2">Borrar perro</h2>
    <div class="formulario-container">
        <h1 class="formulario-title">Borrar Perro</h1>
        ...
        <?php else: ?>
                <form action="eliminarPerro.php" method="POST">
                    ...
                    <select name="idPerro" id="perro" class="formulario-select">
                            ...
                            <?php mostrarPerros($perrosUsuarioSeleccionado, $usuarioSeleccionadoId); ?>
                    </select>
